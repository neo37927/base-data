...
import com.oop.api.jardatamybatissharding.dataSource.param.ESQLOperator;
...
public class SQLUtil {
	...
	public static String likeValue(String value, int type) {
		...
		default:
			return builder.append(Constants.Separator.PERCENT).append(value).append(Constants.Separator.PERCENT)
					.toString();
		}
	}
