...
public class DateUtils {
    ...
    /**
     * @param date   为空：默认当前时间
     * @param format ：为空：默认yyyy-MM-dd
     * @return
     */
...
//			return diff / monthSeconds + "月前";
	...
	* @throws
    ...
    public static String fromMillisToTime(long millis) {
        ...
        long mi = (millis % 1000);
        return builder.append(days).append("天/").append(hours).append("小时/")
                .append(minutes).append("分钟/").append(seconds).append("秒/").append(mi).append("毫秒").toString();
    }
}
